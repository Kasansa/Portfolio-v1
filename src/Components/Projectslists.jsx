const projects = [
  ...
  {
    number: "03",
    title: "Underground conferencing system",
  ...
  {
    number: "04",
    title: "Explosion-proof battery enclosure",
  ...
  },
  {
    number: "05",
    title: "ObaEditor",
    category: "Open-source software · React",
    description: "An interactive browser-based image editor for adding text and shape elements to images, with options to save and share the result.",
    contribution: "Front-end development using React and Tailwind CSS",
    image: "Obaeditor.png",
  },
  {
    number: "06",
    ...
    description: "An exploratory analysis of African COVID-19 statistics between 2019 and 2021, focused on making regional patterns easier to understand.",
    contribution: "Data preparation, analysis and visualisation using Python, Pandas, Matplotlib and Seaborn",
