  ...
  const pageLinks= "Contact";
    ...
    return (
      ...
      <div className="flex flex-col items-center p-8">
        ...
        <div className="w-full max-w-lg bg-slate-600 custom-shadow rounded-lg p-6 space-y-4">
        <div className="text-lg space-y-2">
          ...
          <div className="mt-6">
            <h2 className="text-2xl font-semibold mb-2">Digital Business Card</h2>
            <p className="mb-4 text-gray-600">Download my contact details as a vCard for your phone.</p>
            <a
              href="/KasansaKuya.vcf"
              download="Kasansa_business_card.vcf"
              className="btn btn-primary w-full text-white flex justify-center items-center"
            >
